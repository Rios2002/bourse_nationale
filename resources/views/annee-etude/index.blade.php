@php
    $pagetitle = 'Liste des Annee Etude(s)';
    $breadcrumbs = ['Liste des Annee Etude(s)' => route('annee-etudes.index')];
@endphp
    ...
    <div class="">
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                      @if ($message = Session::get('success'))
                        ...
                        <div class="text-end">
                            <a href="{{ route('annee-etudes.create') }}" class="btn btn-sm btn-primary rounded-05"> Nouveau</a>
                        </div>
                        <div class="col mb-2">
                            <h5 class="card-title text-dark fw-bolder mb-0">Annee Etude(s)</h5>
                            <span>Liste des Annee Etude(s)</span>
                            <hr>
                        </div>
                        <div class="table-responsive">
                            <table class="table table-striped table-hover datatable">
                                ...
                                <tbody>
                                    @foreach ($anneeEtudes as $anneeEtude)
                                        <tr>
                                            <td>{{ ++$i }}</td>
                                            
										<td >{{ $anneeEtude->CodeAnneeEtude }}</td>
                ...
                {!! $anneeEtudes->withQueryString()->links() !!}
            </div>
        </div>
    </div>
@endsection
