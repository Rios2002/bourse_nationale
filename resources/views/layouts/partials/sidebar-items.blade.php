...
@haspermission('gerer parametre de base systeme')
    <li class="sidebar-item">
        ...
        <ul aria-expanded="false" class="collapse first-level">
            ...
            <li class="sidebar-item">
                <a class="sidebar-link primary-hover-bg" href="{{ route('universites.index') }}" aria-expanded="false">
                    <iconify-icon icon="solar:diploma-bold" class="fs-6 aside-icon"></iconify-icon>
                    <span class="hide-menu ps-1">Universite</span>
                </a>
            </li>
            <li class="sidebar-item">
                <a class="sidebar-link primary-hover-bg" href="{{ route('etablissements.index') }}" aria-expanded="false">
                    <iconify-icon icon="solar:diploma-bold" class="fs-6 aside-icon"></iconify-icon>
                    <span class="hide-menu ps-1">Etablissement</span>
                </a>
            </li>
            <li class="sidebar-item">
                <a class="sidebar-link primary-hover-bg" href="{{ route('filieres.index') }}" aria-expanded="false">
                    ...
                    <span class="hide-menu ps-1">Filière</span>
                </a>
            </li>

            <li class="sidebar-item">
                <a class="sidebar-link primary-hover-bg" href="{{ route('annee-etudes.index') }}" aria-expanded="false">
                    <iconify-icon icon="fluent-mdl2:calendar-year" class="fs-6 aside-icon"></iconify-icon>
                    <span class="hide-menu ps-1">Année Etude</span>
                </a>
            </li>


            <li class="sidebar-item">
                <a class="sidebar-link primary-hover-bg" href="{{ route('diplomes.index') }}" aria-expanded="false">
                    <iconify-icon icon="fa-solid:user-graduate" class="fs-6 aside-icon"></iconify-icon>
                    <span class="hide-menu ps-1">Diplôme</span>
                </a>
            </li>
            <li class="sidebar-item">
            ...
            <li class="sidebar-item">
                <a class="sidebar-link primary-hover-bg" href="{{ route('type-bourses.index') }}" aria-expanded="false">
                    <iconify-icon icon="fluent:form-28-regular" class="fs-6 aside-icon"></iconify-icon>
                    <span class="hide-menu ps-1">Type de Bourses</span>
                </a>
            </li>
            <!-- <li class="sidebar-item">
